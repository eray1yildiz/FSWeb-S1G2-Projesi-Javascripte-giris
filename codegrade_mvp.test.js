...
describe("cocukSarkisiFunction", () => {
  it("girilen değere göre geri sayım yapan bir string döner", () => {
    expect(functions.cocukSarkisi(5)).toBe(
      `${5} küçük maymun yatakta zıplamış, biri düşüp başını çarpmış, Anne doktoru aramış, Doktor çok kızmış: Bir daha yatakta zıplamak yok!`
    );
  });
});
